...
Fala se esse casal não é muito fofo? Clique para abrir o álbum! Se quiser, você também pode ver no <a href="https://photos.app.goo.gl/hb3acxd5F6paPSYS9" target="_blank">Google Photos por aqui</a>.
...
stringr::str_glue('![]({fs::dir_ls("images/galeria")}){{group="fotos"}}\n\n')
```
