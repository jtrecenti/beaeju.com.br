...
gerar_tabela_presentes <- function(dados) {
 ambiente <- Sys.getenv("QUARTO_PROFILE")
  if(ambiente == "portugues"){
    stringr::str_glue('![{dados$item} <br> **{dados$estimativa_preco_format}**]({dados$foto}){{group="fotos" description="Caso você queira nos presentear com este item, envie um pix com o valor para<br/>{dados$status}" }}\n\n')
