...
::: grid
```{r}
utensilios_domesticos <- planilha_presentes_nao_recebidos |>
  dplyr::filter(categoria == "utensilios_domesticos") 

if(nrow(utensilios_domesticos) > 0){
    gerar_tabela_presentes(utensilios_domesticos)
} else {
  cat("Agradecemos muito! Recebemos os presentes listados nessa categoria <3")
}
```
:::
...
Agradecemos muito! Recebemos os presentes listados nessa categoria <3
